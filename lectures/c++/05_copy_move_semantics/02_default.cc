...
int main() {
  S s1;  // calls default constructor      random number for int and float and empty string for string
  ...
  S s3{};  // calls {} on each member: S s3 { {}, {}, {} };   0 for int and float, empty string for string             this is the recommended way to construct
