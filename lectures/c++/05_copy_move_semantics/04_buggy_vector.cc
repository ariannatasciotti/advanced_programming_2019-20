...
// copy constructor plus copy assignment -> copy semanthics
...
class Vector {
 ...
 public:
  explicit Vector(const std::size_t length)                // construct vector explicitly from size_t, explicit works only for constructor with one argument
