...
class Animal {
// this is a way to manage private data
  unsigned int age;
  double weight;
...
using Anaconda = DangerousSnake;    // this is a kind of type def since c++11: i'm not creating a new type anaconda, i'm introducing an alias
